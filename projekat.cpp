...
int main()
{
	...
	cv::Mat src = cv::imread("/home/djak1188/Desktop/Projekat/inputs/shapes.png");
	if (src.empty())
		return -1;
	...
	/*
		Laplacian prima kao parametre, ulaznu sliku, sliku odredista, dubinu slike, 
	...
	*/
	...
	cv::imshow("/home/djak1188/Downloads/shapes.png", src);
	cv::imshow("/home/djak1188/Downloads/shapes.png", dst);
	cv::waitKey(0);
	return 0;
}
